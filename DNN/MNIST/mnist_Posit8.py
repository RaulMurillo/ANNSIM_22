...
weight_quant = quantizer(forward_number=Posit(nsize=8,  es=2),   # 8 bits
                        forward_rounding="nearest")
grad_quant = quantizer(forward_number=Posit(nsize=8,  es=2),   # 8 bits
                        forward_rounding="nearest")
# Play with these quants
momentum_quant = quantizer(forward_number=Posit(nsize=16,  es=2), # 16 bits
                        forward_rounding="stochastic")
acc_quant = quantizer(forward_number=Posit(nsize=16,  es=2), # 16 bits
                        forward_rounding="stochastic")

# define a lambda function so that the Quantizer module can be duplicated easily
activate_number = Posit(nsize=8,  es=2)   # (8 bits)
error_number    = Posit(nsize=8,  es=2)   # (8 bits)
